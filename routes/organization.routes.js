...
router.post("/employee-get-otp", OrganizationController.sendOtpForEmployeeSignup)
router.post("/employee-verify-otp", OrganizationController.verifyOtpForEmployeeSignup)
